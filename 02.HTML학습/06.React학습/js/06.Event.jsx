...
/************************************************************* 
    ...
    -> 호출 메서드에 전달값이 있을 경우엔 익명함수(화살표함수)사용함
    예) onclick={()=>{shoot(전달값)}}
    -> 익명함수를 쓰는 이유는 함수호출시 소괄호가 있으면 바로 실행
    되기때문에 이벤트안에 실행안되게 하기 위한 방법임 
*************************************************************/
...
// 축구공 이미지 출력 컴포넌트
function Ball(props){
    return <img id="bb" src={props.isrc} alt="축구공" title="클릭하시면
    공이 날아가요!" onClick={move} />
}
