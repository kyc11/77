...
$(() => {
    ...
    */
    ...
    // 이벤트 대상: 서브밋 버튼 -> #btnj
    // 원래 서브밋 버튼은 클릭시 싸고있는 form태그에 
    // action 속성에 지정되어 있는 페이지로 현재 페이지의
    // input요소들의 값을 가지고 이동하게 되어있다.
    ...
    $("#btnj").click(e=>{
        ...
        if(pass){ // 통과시 if문
            // 메시지 띄우기
            alert("회원가입을 축하드립니다~~ ㅉㅉㅉㅉ")
            // 원래는 호스트방식으로 DB에 회원정보를 입력후
            // DB에 입력완료시 위의 메시지를 띄운다!
